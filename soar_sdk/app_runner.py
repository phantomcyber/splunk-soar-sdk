...
class AppRunner:
    ...
    Note: this is solely derived from the legacy connectors main() function
          generated by the app wizard in SOAR. Will be rewritten in the future
          so consider this a deprecated code at the moment.
