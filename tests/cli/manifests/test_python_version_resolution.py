...
"""
    ...
    def test_greater_than_operator(self, mock_pyproject_toml):
        """Test > operator excludes the exact version."""
        pyproject_content = """
[project]
name = "test-app"
version = "1.0.0"
...
"""
    ...
    def test_less_than_or_equal_operator(self, mock_pyproject_toml):
        """Test <= operator includes the exact version."""
        pyproject_content = """
[project]
name = "test-app"
version = "1.0.0"
...
"""
    ...
    def test_exact_match_operator(self, mock_pyproject_toml):
        """Test == operator for exact version match."""
        pyproject_content = """
[project]
name = "test-app"
version = "1.0.0"
...
"""
    ...
    def test_not_equal_operator(self, mock_pyproject_toml):
        """Test != operator excludes specific version."""
        pyproject_content = """
[project]
name = "test-app"
version = "1.0.0"
