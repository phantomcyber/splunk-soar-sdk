...
if TYPE_CHECKING or not _soar_is_available:
    ...
    class Vault:
        ...
        @abstractmethod
        def _add_attachment(cls, file_location: str, container_id: int, file_name: str = None, metadata: dict[str,str] = None) -> dict:
            """
            Add an attachment to vault.
            """
            return True
        
        def add_attachment(cls, file_location: str, container_id: int, file_name: str = None, metadata: dict[str,str] = None) -> dict:
            """
            Add an attachment to vault.
            """
