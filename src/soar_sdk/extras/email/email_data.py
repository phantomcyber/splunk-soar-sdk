...
@dataclass
class EmailData:
    """Complete extracted data from an email message (RFC 5322 or Outlook MSG)."""
...
def extract_rfc5322_email_data(
    ...
    """Deprecated: use extract_email_data instead."""
    warnings.warn(
        "extract_rfc5322_email_data is deprecated, use extract_email_data instead",
        DeprecationWarning,
        stacklevel=2,
    )
    return extract_email_data(rfc822_email, email_id, include_attachment_content)
